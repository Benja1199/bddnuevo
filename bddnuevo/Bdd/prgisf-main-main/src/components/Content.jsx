                ...
                <div className="row">
                    ...
                    <div className="card">
                        ...
                        <div className="d-flex justify-content-between">
                            <h3 className="card-title">Historia de Vinos Don Rogelio</h3>
                        </div>
                        </div>
                <p className="card-text">
                    Hace más de tres décadas, en el corazón de una región vinícola, nacía la bodega Vinos Don Rogelio, un sueño gestado en la pasión y dedicación de su fundador, don Rogelio Castro. Este hombre visionario, proveniente de una familia con raíces en la viticultura, decidió embarcarse en la aventura de crear su propia marca de vinos con un enfoque único y un compromiso inquebrantable con la calidad.
                </p>
                    </div>
                    {/* /.card */}
                    <div className="card">
                        ...
                        <table className="table table-striped table-valign-middle">
                            ...
                            <tr>
                                <td>
                                <img src="" alt="Product 1" className="img-circle img-size-32 mr-2" />
                                Vino Tinto Bidon
                                </td>
                                <td>$13 USD</td>
                                <td>
